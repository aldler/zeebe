...
public class MetaStoreTest {
  ...
  @Test
  public void shouldStoreAndLoadAppendedIndex() {
    // given
    metaStore.storeLastAppendedIndex(5L);

    // when/then
    assertThat(metaStore.loadLastAppendedIndex()).isEqualTo(5L);
  }

  @Test
  public void shouldStoreAndLoadAppendedIndexAfterRestart() throws IOException {
    // given
    metaStore.storeLastAppendedIndex(5L);
